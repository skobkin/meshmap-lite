...
var schemaMigrations = []migrationStep{
	...
	{version: 6, name: "log_events", apply: migrateV6LogEvents},
	{version: 7, name: "topology_edges", apply: migrateV7TopologyEdges},
	{version: 8, name: "log_event_range_test_kind", apply: migrateV8LogEventRangeTestKind},
	{version: 9, name: "log_event_pki_kind", apply: migrateV9LogEventPKIKind},
	{version: 10, name: "activity_indexes", apply: migrateV10ActivityIndexes},
	{version: 11, name: "mqtt_uploader_provenance", apply: migrateV11MQTTUploaderProvenance},
	{version: 12, name: "node_name_history", apply: migrateV12NodeNameHistory},
	{version: 13, name: "topology_mqtt_direct_source", apply: migrateV13TopologyMQTTDirectSource},
	{version: 14, name: "discard_zero_positions", apply: migrateV14DiscardZeroPositions},
	{version: 15, name: "hop_tracking", apply: migrateV15HopTracking},
	{version: 16, name: "chat_reactions", apply: migrateV16ChatReactions},
	...
	{version: 21, name: "firmware_versions_normalized", apply: migrateV21FirmwareVersionsNormalized},
	{version: 22, name: "map_report_seen_at", apply: migrateV22MapReportSeenAt},
	{version: 23, name: "hardware_models_normalized", apply: migrateV23HardwareModelsNormalized},
}
